...
public class JugadorDetailActivity extends AppCompatActivity {
    ...
    public void eliminarPerfil(View view) {
        ...
        alertDialog.setMessage("¿Estás seguro que deseas eliminar este jugador?");
        alertDialog.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                DatabaseReference dR = FirebaseDatabase.getInstance().getReference("Jugadores").child(jugador.getId());
                dR.removeValue();
